exports.paymentSuccess = (amount, paymentId, orderId, name, lastname) => {
  return `<!DOCTYPE html>
    ...
    <body>
        <div class="container">
            <a href="https://learnquest-edtech-project.vercel.app"><img class="logo" src="https://res.cloudinary.com/dih2jpjmx/image/upload/v1726255793/mzcuqudzr8caciikluei.png"
